      ...
      <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            ...
            className="mt-4 px-4 py-2 bg-neutral-500 text-white rounded-lg hover:bg-neutral-600"
          >
            Try Again
          </button>
        </div>
          ...
          <>
            ...
            {hasMore && (
              <div className="mt-12 text-center">
                <button onClick={loadMore} disabled={loading} className="px-6 py-3 bg-neutral-500 text-white rounded-lg hover:bg-neutral-600 disabled:opacity-50">
